...
def get_embeddings(provider: str = "huggingface", model_name: str = "sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2"):
    if provider == "huggingface":
        # BGE-M3 is a stronger multilingual retrieval encoder. Normalize vectors for cosine-style search.
        encode_kwargs = {"normalize_embeddings": True} if model_name == "BAAI/bge-m3" else {}
