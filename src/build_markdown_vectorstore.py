...
from src.config import CHROMA_DB_DIR_MARKDOWN, DATA_DIR
...
def main():
    print("==================================================")
    print("   Building Markdown-based Vector Store in vect/  ")
    print("==================================================")
    print(f"[Info] Source PDF Directory: {DATA_DIR}")
    print(f"[Info] Target VectorDB Directory: {CHROMA_DB_DIR_MARKDOWN}")

    vs = build_or_load_vectorstore(
        persist_directory=CHROMA_DB_DIR_MARKDOWN,
        force_rebuild=True,
        loader="markdown",
    )
    print("[Success] Markdown-based Vector Store Build Complete in vect/!")
